    ...
    return Padding(padding: const EdgeInsets.fromLTRB(8, 0, 20,0),
      child: ClipRect(
        child: Container(
          ...
          width: MediaQuery.of(context).size.width*0.76,////0.8 yok
              ...
              children: [
                ...
                Padding(padding: const EdgeInsets.only(left: 8),
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                        Text(widget.name,style: appStyleWithHt(25, Colors.black, FontWeight.bold, 1.1),),
                ...
                Padding(padding: const EdgeInsets.only(left: 8,right: 8),
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(widget.price,style: appStyle(28, Colors.black, FontWeight.w600),),
                      Row(children: [
